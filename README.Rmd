...
```{r fastshap-comparison, cache=TRUE, echo=FALSE, fig.width=7, fig.asp=1, out.width="100%"}
# Compare plots
...
```{r fastshap-convergence, cache=TRUE, echo=FALSE, fig.width=7, fig.asp=1, out.width="100%"}
