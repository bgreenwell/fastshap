...
[![Launch Rstudio Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/bgreenwell/fastshap/master?urlpath=rstudio)
<!-- badges: end -->

The goal of **fastshap** is to provide an efficient way to compute the approximate Shapley values discussed in [Molnar (2019)](https://christophm.github.io/interpretable-ml-book/shapley.html). 
...
knitr::include_graphics("man/figures/algorithm1.png")
```
...
```{r shap-autoplot, cache=TRUE, fig.width=7, fig.asp=0.4, out.width="70%"}
p1 <- autoplot(shap)
